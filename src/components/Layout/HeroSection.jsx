        ...
        <section className="relative min-h-screen bg-gray-900 text-white overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-6 py-20 max-w-7xl mx-auto gap-12">
            ...
            <div className="lg:w-1/4 w-full flex justify-center">
              ...
              <img
                src="https://cdn.dribbble.com/users/112648/screenshots/14613821/media/6a9c64b6b4767a28185b7ec56f595618.gif"
                alt="Quiz Animation"
                className="max-w-xs sm:max-w-sm rounded-xl shadow-lg"
              />
            </div>
          </div>
        </section>
